...
require File.expand_path('../../../common/ruby_test_unit_integration_tests', __FILE__)

describe 'Integration with Test::Unit ~> 2.4' do
  include RubyTestUnitIntegrationTests
